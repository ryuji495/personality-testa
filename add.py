...
question_tree = {
    ...
    "q9": {"text": "感情的になりやすいと思う？", "yes": "g", "no": "h"},
     # --- 診断結果 ---
    "a": "🌟 あなたは **ポジティブタイプ** です！<br>"
          "自分の人生に起きるどんな出来事でもプラスに解釈し、<br>"
          "困難な状況に遭遇しても積極的に前進できる人",
    "b": "🌸 あなたは **優しいタイプ** です！<br>"
          "相手の立場を思いやり、共感する能力が高く、聞き上手で、否定的な言葉を避ける、<br>"
          "そして自然体で穏やかな雰囲気を持っている人",
    "c": "🌧 あなたは **ネガティブタイプ** です！<br>"
          "常に最低の事態を想定しており、<br>"
          "いざ何か起こったときにも立ち直りや対策を練ることができる人",
    "d": "🔥 あなたは **怒りっぽいタイプ** です！<br>"
          "感情表現がストレートで人間関係を築きやすい、<br>"
          "大切なものを守ろうとする強い意志や真剣さを持つ、<br>"
          "不満を前向きなエネルギーに変えて行動できる人",
    "e": "❄️ あなたは **クールタイプ** です！<br>"
          "感情を表に出さず冷静、周りに流されずに自分のポリシーを持っている、<br>"
          "ミステリアスな雰囲気の人",
    "f": "🌙 あなたは **おとなしいタイプ** です！<br>"
          "穏やかで物静か、一人の時間を大切にする、<br>"
          "周りの状況を冷静に観察する視点を持つ人",
    "g": "🎭 あなたは **感情豊かなタイプ** です！<br>"
          "共感力が高く、繊細で、感情表現が豊か、<br>"
          "芸術に感動したり、日常生活に喜びを見出したりと、<br>"
          "様々なものに深く心を動かされる人",
    "h": "💪 あなたは **熱血タイプ** です！<br>"
          "エネルギッシュで情熱的、<br>"
          "周りを鼓舞して人を巻き込む力がある人",
    "i": "🌼 あなたは **天然タイプ** です！<br>"
          "素直で裏表のない感情表現、独特な発想や感性、<br>"
          "おっちょこちょいな一面、<br>"
          "そして他人の評価を気にしないマイペースな人",
    "j": "🌀 あなたは **変人タイプ** です！<br>"
          "強いこだわりを持つ、特定の話題に没頭する、<br>"
          "周囲と比べて独特な価値観や行動、考え方を持つ少し変わった人。<br>"
          "もしかしたら✮**天才**✮かも"
}
