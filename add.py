...
question_tree = {
    ...
    "q6": {"text": "自分より他人のことを優先する", "yes": "b", "no": "a"},
    "q7": {"text": "失敗してしまったら落ち込むよりもイライラする", "yes": "c", "no": "d"},
    "q8": {"text": "一人よりも大人数のほうがいい", "yes": "e", "no": "f"},
    "q9": {"text": "感情的になりやすいと思う？", "yes": "g", "no": "h"},
    # --- 診断結果 ---
    "a": "🌟 あなたは **ポジティブタイプ** です！  \n"
          "自分の人生に起きるどんな出来事でもプラスに解釈し、困難な状況に遭遇しても積極的に前進できる人",
    "b": "🌸 あなたは **優しいタイプ** です！  \n"
          "相手の立場を思いやり、共感する能力が高く、聞き上手で、否定的な言葉を避ける、そして自然体で穏やかな雰囲気を持っている人",
    "c": "🌧 あなたは **ネガティブタイプ** です！  \n"
          "常に最低の事態を想定しており、いざ何か起こったときにも立ち直りや対策を練ることができる人",
    "d": "🔥 あなたは **怒りっぽいタイプ** です！  \n"
          "感情表現がストレートで人間関係を築きやすい、大切なものを守ろうとする強い意志や真剣さを持つ、不満を前向きなエネルギーに変えて行動できる人",
    "e": "❄️ あなたは **クールタイプ** です！  \n"
          "感情を表に出さず冷静、周りに流されずに自分のポリシーを持っている、ミステリアスな雰囲気の人",
    "f": "🌙 あなたは **おとなしいタイプ** です！  \n"
          "穏やかで物静か、一人の時間を大切にする、周りの状況を冷静に観察する視点を持つ人",
    "g": "🎭 あなたは **感情豊かなタイプ** です！  \n"
          "共感力が高く、繊細で、感情表現が豊か、芸術に感動したり、日常生活に喜びを見出したりと、様々なものに深く心を動かされる人",
    "h": "💪 あなたは **熱血タイプ** です！  \n"
          "エネルギッシュで情熱的、周りを鼓舞して人を巻き込む力がある人",
    "i": "🌼 あなたは **天然タイプ** です！  \n"
          "素直で裏表のない感情表現、独特な発想や感性、おっちょこちょいな一面、そして他人の評価を気にしないマイペースな人",
    "j": "🌀 あなたは **変人タイプ** です！  \n"
          "強いこだわりを持つ、特定の話題に没頭する、周囲と比べて独特な価値観や行動、考え方を持つ少し変わった人。もしかしたら✮**天才**✮かも"
}
